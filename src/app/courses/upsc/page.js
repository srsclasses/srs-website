    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      <div className="max-w-2xl w-full text-center">
        ...
        >
          ...
          <Link 
            href="/courses"
            className="inline-flex items-center justify-center px-8 py-3 border border-foreground/20 text-base font-medium rounded-lg text-foreground bg-background hover:bg-primary/5 md:text-lg transition-colors shadow-sm hover:shadow-md"
          >
